...
<div class="dashboard-wrapper">
    ...
    <div class="card-box">
        ...
        <p>Role ini melakukan validasi lanjutan setelah KPS diajukan. Jika semua 9 kriteria divalidasi, tombol ekspor dokumen final akan muncul. Jika ada revisi, kriteria dikembalikan ke admin dengan komentar.</p>
    </div>
